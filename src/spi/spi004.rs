...
impl W {
    #[doc = "Bit 0 - CE0 SPI address mode selection"]
    #[inline(always)]
    pub fn ce0spiaddr_mode_sel(&mut self) -> Ce0spiaddrModeSelW<Spi004Spec> {
        Ce0spiaddrModeSelW::new(self, 0)
    }
    #[doc = "Bit 1 - CE1 SPI address mode selection"]
    #[inline(always)]
    pub fn ce1spiaddr_mode_sel(&mut self) -> Ce1spiaddrModeSelW<Spi004Spec> {
        Ce1spiaddrModeSelW::new(self, 1)
    }
    #[doc = "Bit 4 - CE0 4B address Auto-Read command selection"]
    #[inline(always)]
    pub fn ce04baddr_auto_read_cmd_sel(&mut self) -> Ce04baddrAutoReadCmdSelW<Spi004Spec> {
        Ce04baddrAutoReadCmdSelW::new(self, 4)
    }
    #[doc = "Bit 5 - CE1 4B address Auto-Read command selection"]
    #[inline(always)]
    pub fn ce14baddr_auto_read_cmd_sel(&mut self) -> Ce14baddrAutoReadCmdSelW<Spi004Spec> {
    ...
    pub fn select_ce0minimum_inactive_timing_tcsh(
        &mut self,
    ) -> SelectCe0minimumInactiveTimingTcshW<Spi004Spec> {
    ...
    pub fn select_ce1minimum_inactive_timing_tcsh(
        &mut self,
    ) -> SelectCe1minimumInactiveTimingTcshW<Spi004Spec> {
...
#[doc = "`reset()` method sets SPI004 to value 0x2a00"]

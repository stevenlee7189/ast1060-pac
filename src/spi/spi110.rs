#[doc = "Register `SPI110` reader"]
pub type R = crate::R<Spi110Spec>;
#[doc = "Register `SPI110` writer"]
pub type W = crate::W<Spi110Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd13(&mut self) -> FullyQualifiedCmd13W<Spi110Spec> {
        FullyQualifiedCmd13W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd4(&mut self) -> FullyQualifiedCmd4W<Spi110Spec> {
        FullyQualifiedCmd4W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry4(&mut self) -> EnblEntry4W<Spi110Spec> {
        EnblEntry4W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`spi110::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi110::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi110Spec;
impl crate::RegisterSpec for Spi110Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi110::R`](R) reader structure"]
impl crate::Readable for Spi110Spec {}
#[doc = "`write(|w| ..)` method takes [`spi110::W`](W) writer structure"]
impl crate::Writable for Spi110Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI110 to value 0x8000_0101"]
impl crate::Resettable for Spi110Spec {
    const RESET_VALUE: u32 = 0x8000_0101;
}

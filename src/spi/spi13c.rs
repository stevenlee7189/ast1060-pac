#[doc = "Register `SPI13C` reader"]
pub type R = crate::R<Spi13cSpec>;
#[doc = "Register `SPI13C` writer"]
pub type W = crate::W<Spi13cSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd17(&mut self) -> FullyQualifiedCmd17W<Spi13cSpec> {
        FullyQualifiedCmd17W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd8(&mut self) -> FullyQualifiedCmd8W<Spi13cSpec> {
        FullyQualifiedCmd8W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry8(&mut self) -> EnblEntry8W<Spi13cSpec> {
        EnblEntry8W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`spi13c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi13c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi13cSpec;
impl crate::RegisterSpec for Spi13cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi13c::R`](R) reader structure"]
impl crate::Readable for Spi13cSpec {}
#[doc = "`write(|w| ..)` method takes [`spi13c::W`](W) writer structure"]
impl crate::Writable for Spi13cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI13C to value 0"]
impl crate::Resettable for Spi13cSpec {}

...
impl W {
    ...
    pub fn spiclkhclk2delay_cycle_for_data_input_latch_point1(
        &mut self,
    ) -> Spiclkhclk2delayCycleForDataInputLatchPoint1W<Spi098Spec> {
    ...
    pub fn spiclkhclk3delay_cycle_for_data_input_latch_point1(
        &mut self,
    ) -> Spiclkhclk3delayCycleForDataInputLatchPoint1W<Spi098Spec> {
    ...
    pub fn spiclkhclk4delay_cycle_for_data_input_latch_point1(
        &mut self,
    ) -> Spiclkhclk4delayCycleForDataInputLatchPoint1W<Spi098Spec> {
    ...
    pub fn spiclkhclk5delay_cycle_for_data_input_latch_point1(
        &mut self,
    ) -> Spiclkhclk5delayCycleForDataInputLatchPoint1W<Spi098Spec> {

#[doc = "Register `SPI130` reader"]
pub type R = crate::R<Spi130Spec>;
#[doc = "Register `SPI130` writer"]
pub type W = crate::W<Spi130Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd17(&mut self) -> FullyQualifiedCmd17W<Spi130Spec> {
        FullyQualifiedCmd17W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd8(&mut self) -> FullyQualifiedCmd8W<Spi130Spec> {
        FullyQualifiedCmd8W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry8(&mut self) -> EnblEntry8W<Spi130Spec> {
        EnblEntry8W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`spi130::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi130::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi130Spec;
impl crate::RegisterSpec for Spi130Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi130::R`](R) reader structure"]
impl crate::Readable for Spi130Spec {}
#[doc = "`write(|w| ..)` method takes [`spi130::W`](W) writer structure"]
impl crate::Writable for Spi130Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI130 to value 0"]
impl crate::Resettable for Spi130Spec {}

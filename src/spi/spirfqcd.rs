#[doc = "Register `SPIRFQCD[%s]` reader"]
pub type R = crate::R<SpirfqcdSpec>;
#[doc = "Register `SPIRFQCD[%s]` writer"]
pub type W = crate::W<SpirfqcdSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd17(&mut self) -> FullyQualifiedCmd17W<SpirfqcdSpec> {
        FullyQualifiedCmd17W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd8(&mut self) -> FullyQualifiedCmd8W<SpirfqcdSpec> {
        FullyQualifiedCmd8W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry8(&mut self) -> EnblEntry8W<SpirfqcdSpec> {
        EnblEntry8W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`spirfqcd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spirfqcd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpirfqcdSpec;
impl crate::RegisterSpec for SpirfqcdSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spirfqcd::R`](R) reader structure"]
impl crate::Readable for SpirfqcdSpec {}
#[doc = "`write(|w| ..)` method takes [`spirfqcd::W`](W) writer structure"]
impl crate::Writable for SpirfqcdSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPIRFQCD[%s] to value 0"]
impl crate::Resettable for SpirfqcdSpec {}

...
impl W {
    #[doc = "Bit 1 - SPI Write Address Protected Interrupt Enable"]
    #[inline(always)]
    pub fn spiwr_addr_protected_intenbl(&mut self) -> SpiwrAddrProtectedIntenblW<Spi008Spec> {
        SpiwrAddrProtectedIntenblW::new(self, 1)
    }
    #[doc = "Bit 2 - SPI Command Abort Interrupt Enable"]
    #[inline(always)]
    pub fn spicmd_abort_intenbl(&mut self) -> SpicmdAbortIntenblW<Spi008Spec> {
        SpicmdAbortIntenblW::new(self, 2)
    }
    #[doc = "Bit 3 - DMA Interrupt Enable"]
    #[inline(always)]
    pub fn dmaintenbl(&mut self) -> DmaintenblW<Spi008Spec> {
    ...
    pub fn dmabuffer_mode_fifofull_empty_intenbl(
        &mut self,
    ) -> DmabufferModeFifofullEmptyIntenblW<Spi008Spec> {
        DmabufferModeFifofullEmptyIntenblW::new(self, 4)
    }
    #[doc = "Bit 9 - SPI Write Address Protected Status"]
    #[inline(always)]
    pub fn spiwr_addr_protected_status(&mut self) -> SpiwrAddrProtectedStatusW<Spi008Spec> {
        SpiwrAddrProtectedStatusW::new(self, 9)
    }
    #[doc = "Bit 10 - SPI Command Abort Status"]
    #[inline(always)]
    pub fn spicmd_abort_status(&mut self) -> SpicmdAbortStatusW<Spi008Spec> {

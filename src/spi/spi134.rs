#[doc = "Register `SPI134` reader"]
pub type R = crate::R<Spi134Spec>;
#[doc = "Register `SPI134` writer"]
pub type W = crate::W<Spi134Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd17(&mut self) -> FullyQualifiedCmd17W<Spi134Spec> {
        FullyQualifiedCmd17W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd8(&mut self) -> FullyQualifiedCmd8W<Spi134Spec> {
        FullyQualifiedCmd8W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry8(&mut self) -> EnblEntry8W<Spi134Spec> {
        EnblEntry8W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`spi134::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi134::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi134Spec;
impl crate::RegisterSpec for Spi134Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi134::R`](R) reader structure"]
impl crate::Readable for Spi134Spec {}
#[doc = "`write(|w| ..)` method takes [`spi134::W`](W) writer structure"]
impl crate::Writable for Spi134Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI134 to value 0"]
impl crate::Resettable for Spi134Spec {}

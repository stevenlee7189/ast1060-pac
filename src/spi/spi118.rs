#[doc = "Register `SPI118` reader"]
pub type R = crate::R<Spi118Spec>;
#[doc = "Register `SPI118` writer"]
pub type W = crate::W<Spi118Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd15(&mut self) -> FullyQualifiedCmd15W<Spi118Spec> {
        FullyQualifiedCmd15W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd6(&mut self) -> FullyQualifiedCmd6W<Spi118Spec> {
        FullyQualifiedCmd6W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry6(&mut self) -> EnblEntry6W<Spi118Spec> {
        EnblEntry6W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`spi118::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi118::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi118Spec;
impl crate::RegisterSpec for Spi118Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi118::R`](R) reader structure"]
impl crate::Readable for Spi118Spec {}
#[doc = "`write(|w| ..)` method takes [`spi118::W`](W) writer structure"]
impl crate::Writable for Spi118Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI118 to value 0x8000_0404"]
impl crate::Resettable for Spi118Spec {
    const RESET_VALUE: u32 = 0x8000_0404;
}

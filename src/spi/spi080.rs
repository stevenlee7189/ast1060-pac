...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Dmagrant {
    #[doc = "0: DMA is not allowed to be used. All DMA related control registers are not allowed to be written."]
    DmaIsNotAllowedToBeUsedAllDmaRelatedControlRegistersAreNotAllowedToBeWritten = 0,
    #[doc = "1: DMA is granted to be used."]
    DmaIsGrantedToBeUsed = 1,
}
impl From<Dmagrant> for bool {
    #[inline(always)]
    fn from(variant: Dmagrant) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `DMAGrant` reader - DMA Grant"]
pub type DmagrantR = crate::BitReader<Dmagrant>;
impl DmagrantR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Dmagrant {
        match self . bits { false => Dmagrant :: DmaIsNotAllowedToBeUsedAllDmaRelatedControlRegistersAreNotAllowedToBeWritten , true => Dmagrant :: DmaIsGrantedToBeUsed , }
    }
    #[doc = "DMA is not allowed to be used. All DMA related control registers are not allowed to be written."]
    #[inline(always)]
    pub fn is_dma_is_not_allowed_to_be_used_all_dma_related_control_registers_are_not_allowed_to_be_written(
        &self,
    ) -> bool {
        * self == Dmagrant :: DmaIsNotAllowedToBeUsedAllDmaRelatedControlRegistersAreNotAllowedToBeWritten
    }
    #[doc = "DMA is granted to be used."]
    #[inline(always)]
    pub fn is_dma_is_granted_to_be_used(&self) -> bool {
        *self == Dmagrant::DmaIsGrantedToBeUsed
    }
}
...
impl R {
    ...
    #[doc = "Bit 30 - DMA Grant"]
    #[inline(always)]
    pub fn dmagrant(&self) -> DmagrantR {
        DmagrantR::new(((self.bits >> 30) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - DMA Enable"]
    #[inline(always)]
    pub fn dmaenbl(&mut self) -> DmaenblW<Spi080Spec> {
        DmaenblW::new(self, 0)
    }
    #[doc = "Bit 1 - DMA Direction"]
    #[inline(always)]
    pub fn dmadirection(&mut self) -> DmadirectionW<Spi080Spec> {
        DmadirectionW::new(self, 1)
    }
    #[doc = "Bit 2 - CheckSum Calculation Only"]
    #[inline(always)]
    pub fn check_sum_calculation_only(&mut self) -> CheckSumCalculationOnlyW<Spi080Spec> {
        CheckSumCalculationOnlyW::new(self, 2)
    }
    #[doc = "Bit 3 - Calibration Mode"]
    #[inline(always)]
    pub fn calibration_mode(&mut self) -> CalibrationModeW<Spi080Spec> {
        CalibrationModeW::new(self, 3)
    }
    #[doc = "Bit 4 - DMA Buffer Mode"]
    #[inline(always)]
    pub fn dmabuffer_mode(&mut self) -> DmabufferModeW<Spi080Spec> {
    ...
    pub fn spiread_data_input_delay_cycle_setting(
        &mut self,
    ) -> SpireadDataInputDelayCycleSettingW<Spi080Spec> {
        SpireadDataInputDelayCycleSettingW::new(self, 8)
    }
    #[doc = "Bits 16:19 - SPI clock frequency setting"]
    #[inline(always)]
    pub fn spiclk_frequency_setting(&mut self) -> SpiclkFrequencySettingW<Spi080Spec> {
        SpiclkFrequencySettingW::new(self, 16)
    }
    #[doc = "Bit 31 - DMA Request"]
    #[inline(always)]
    pub fn dmareq(&mut self) -> DmareqW<Spi080Spec> {
        DmareqW::new(self, 31)
    }
}

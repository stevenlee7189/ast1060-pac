#[doc = "Register `SPI0C0` reader"]
pub type R = crate::R<Spi0c0Spec>;
#[doc = "Register `SPI0C0` writer"]
pub type W = crate::W<Spi0c0Spec>;
...
impl W {
    ...
    pub fn segments_lower_bound_addr_bit27124(
        &mut self,
    ) -> SegmentsLowerBoundAddrBit27124W<Spi0c0Spec> {
    ...
    pub fn segments_upper_bound_addr_bit27124(
        &mut self,
    ) -> SegmentsUpperBoundAddrBit27124W<Spi0c0Spec> {
        SegmentsUpperBoundAddrBit27124W::new(self, 16)
    }
}
#[doc = "Write Address Filter Register \\#5\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0c0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0c0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0c0Spec;
impl crate::RegisterSpec for Spi0c0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0c0::R`](R) reader structure"]
impl crate::Readable for Spi0c0Spec {}
#[doc = "`write(|w| ..)` method takes [`spi0c0::W`](W) writer structure"]
impl crate::Writable for Spi0c0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0C0 to value 0"]
impl crate::Resettable for Spi0c0Spec {}

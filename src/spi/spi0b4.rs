#[doc = "Register `SPI0B4` reader"]
pub type R = crate::R<Spi0b4Spec>;
#[doc = "Register `SPI0B4` writer"]
pub type W = crate::W<Spi0b4Spec>;
...
impl W {
    ...
    pub fn segments_lower_bound_addr_bit27121(
        &mut self,
    ) -> SegmentsLowerBoundAddrBit27121W<Spi0b4Spec> {
    ...
    pub fn segments_upper_bound_addr_bit27121(
        &mut self,
    ) -> SegmentsUpperBoundAddrBit27121W<Spi0b4Spec> {
        SegmentsUpperBoundAddrBit27121W::new(self, 16)
    }
}
#[doc = "Write Address Filter Register \\#2\n\nYou can [`read`](crate::Reg::read) this register and get [`spi0b4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi0b4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi0b4Spec;
impl crate::RegisterSpec for Spi0b4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi0b4::R`](R) reader structure"]
impl crate::Readable for Spi0b4Spec {}
#[doc = "`write(|w| ..)` method takes [`spi0b4::W`](W) writer structure"]
impl crate::Writable for Spi0b4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI0B4 to value 0"]
impl crate::Resettable for Spi0b4Spec {}

#[doc = "Register `SPI10C` reader"]
pub type R = crate::R<Spi10cSpec>;
#[doc = "Register `SPI10C` writer"]
pub type W = crate::W<Spi10cSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd12(&mut self) -> FullyQualifiedCmd12W<Spi10cSpec> {
        FullyQualifiedCmd12W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd3(&mut self) -> FullyQualifiedCmd3W<Spi10cSpec> {
        FullyQualifiedCmd3W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry3(&mut self) -> EnblEntry3W<Spi10cSpec> {
        EnblEntry3W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`spi10c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spi10c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spi10cSpec;
impl crate::RegisterSpec for Spi10cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spi10c::R`](R) reader structure"]
impl crate::Readable for Spi10cSpec {}
#[doc = "`write(|w| ..)` method takes [`spi10c::W`](W) writer structure"]
impl crate::Writable for Spi10cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPI10C to value 0x8000_0505"]
impl crate::Resettable for Spi10cSpec {
    const RESET_VALUE: u32 = 0x8000_0505;
}

...
#[doc = "Field `EnblSaveAddrByteIntoBufForSlavePktModeRxCmd` reader - Enable save address byte into buffer for Slave Packet mode receive command"]
pub type EnblSaveAddrByteIntoBufForSlavePktModeRxCmdR = crate::BitReader;
#[doc = "Field `EnblSaveAddrByteIntoBufForSlavePktModeRxCmd` writer - Enable save address byte into buffer for Slave Packet mode receive command"]
pub type EnblSaveAddrByteIntoBufForSlavePktModeRxCmdW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `DisDMAAutoRecoveryWhenResidualTxCountEquals0` reader - DisableDMA AutoRecovery when residual Tx Count equals 0"]
pub type DisDmaautoRecoveryWhenResidualTxCountEquals0R = crate::BitReader;
#[doc = "Field `DisDMAAutoRecoveryWhenResidualTxCountEquals0` writer - DisableDMA AutoRecovery when residual Tx Count equals 0"]
pub type DisDmaautoRecoveryWhenResidualTxCountEquals0W<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `EnblRBEarlyDone` reader - Enable RB early done"]
pub type EnblRbearlyDoneR = crate::BitReader;
#[doc = "Field `EnblRBEarlyDone` writer - Enable RB early done"]
...
impl R {
    ...
    #[doc = "Bit 20 - Enable save address byte into buffer for Slave Packet mode receive command"]
    #[inline(always)]
    ...
    #[doc = "Bit 21 - DisableDMA AutoRecovery when residual Tx Count equals 0"]
    #[inline(always)]
    ...
    #[doc = "Bit 22 - Enable RB early done"]
    #[inline(always)]

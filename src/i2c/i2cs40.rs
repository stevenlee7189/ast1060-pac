...
#[doc = "Field `SameAsHlinkI2CD18` reader - Same as hlinkI2CD18"]
pub type SameAsHlinkI2cd18R = crate::FieldReader<u32>;
#[doc = "Field `SameAsHlinkI2CD18` writer - Same as hlinkI2CD18"]
pub type SameAsHlinkI2cd18W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Same as hlinkI2CD18"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd18(&self) -> SameAsHlinkI2cd18R {
        SameAsHlinkI2cd18R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Same as hlinkI2CD18"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd18(&mut self) -> SameAsHlinkI2cd18W<I2cs40Spec> {
        SameAsHlinkI2cd18W::new(self, 0)
    }
}

...
#[doc = "Field `SameAsHlinkI2CD1C` reader - Same as hlinkI2CD1C"]
pub type SameAsHlinkI2cd1cR = crate::FieldReader<u32>;
#[doc = "Field `SameAsHlinkI2CD1C` writer - Same as hlinkI2CD1C"]
pub type SameAsHlinkI2cd1cW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - Same as hlinkI2CD1C"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd1c(&self) -> SameAsHlinkI2cd1cR {
        SameAsHlinkI2cd1cR::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Same as hlinkI2CD1C"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd1c(&mut self) -> SameAsHlinkI2cd1cW<I2cc0cSpec> {
        SameAsHlinkI2cd1cW::new(self, 0)
    }
}

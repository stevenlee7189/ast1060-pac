...
#[doc = "Field `SameAsHlinkI2CD20` reader - Same as hlinkI2CD20"]
pub type SameAsHlinkI2cd20R = crate::FieldReader<u16>;
#[doc = "Field `SameAsHlinkI2CD20` writer - Same as hlinkI2CD20"]
pub type SameAsHlinkI2cd20W<'a, REG> = crate::FieldWriter<'a, REG, 16, u16>;
#[doc = "Field `SameAsHlinkI2CD14` reader - Same as hlinkI2CD14"]
pub type SameAsHlinkI2cd14R = crate::FieldReader<u16>;
impl R {
    #[doc = "Bits 0:15 - Same as hlinkI2CD20"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd20(&self) -> SameAsHlinkI2cd20R {
        SameAsHlinkI2cd20R::new((self.bits & 0xffff) as u16)
    }
    #[doc = "Bits 16:31 - Same as hlinkI2CD14"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd14(&self) -> SameAsHlinkI2cd14R {
        SameAsHlinkI2cd14R::new(((self.bits >> 16) & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Same as hlinkI2CD20"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd20(&mut self) -> SameAsHlinkI2cd20W<I2cc08Spec> {
        SameAsHlinkI2cd20W::new(self, 0)
    }
}

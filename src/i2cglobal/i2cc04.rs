...
#[doc = "Field `SameAsHlinkI2CD04` reader - Same as hlinkI2CD04"]
pub type SameAsHlinkI2cd04R = crate::FieldReader<u32>;
#[doc = "Field `SameAsHlinkI2CD04` writer - Same as hlinkI2CD04"]
pub type SameAsHlinkI2cd04W<'a, REG> = crate::FieldWriter<'a, REG, 20, u32>;
...
#[doc = "Field `SameAsHlinkI2CD08` reader - Same as hlinkI2CD08"]
pub type SameAsHlinkI2cd08R = crate::FieldReader;
#[doc = "Field `SameAsHlinkI2CD08` writer - Same as hlinkI2CD08"]
pub type SameAsHlinkI2cd08W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
#[doc = "Field `Reserved0` reader - Reserved (0)"]
pub type Reserved0R = crate::FieldReader;
impl R {
    #[doc = "Bits 0:19 - Same as hlinkI2CD04"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd04(&self) -> SameAsHlinkI2cd04R {
        SameAsHlinkI2cd04R::new(self.bits & 0x000f_ffff)
    }
    ...
    #[inline(always)]
    pub fn same_as_hlink_i2cd08(&self) -> SameAsHlinkI2cd08R {
        SameAsHlinkI2cd08R::new(((self.bits >> 24) & 0x1f) as u8)
    }
...
impl W {
    #[doc = "Bits 0:19 - Same as hlinkI2CD04"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd04(&mut self) -> SameAsHlinkI2cd04W<I2cc04Spec> {
        SameAsHlinkI2cd04W::new(self, 0)
    }
    #[doc = "Bits 20:23 - newverCycles of master SCL clock-high minimum pulse width (tCKHighMin)"]
    #[inline(always)]
    pub fn cycles_of_master_sclclkhigh_minimum_pulse_width_tckhigh_min(
    ...
    #[doc = "Bits 24:28 - Same as hlinkI2CD08"]
    #[inline(always)]
    pub fn same_as_hlink_i2cd08(&mut self) -> SameAsHlinkI2cd08W<I2cc04Spec> {
        SameAsHlinkI2cd08W::new(self, 24)
    }
}

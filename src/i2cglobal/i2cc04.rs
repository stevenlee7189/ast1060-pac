...
#[doc = "Field `BaseClkDivisorTBaseClk` reader - newverBase Clock divisor (tBaseClk)"]
pub type BaseClkDivisorTbaseClkR = crate::FieldReader;
#[doc = "Field `BaseClkDivisorTBaseClk` writer - newverBase Clock divisor (tBaseClk)"]
pub type BaseClkDivisorTbaseClkW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `TimeoutBaseClkDivisorToutBaseClk` reader - newverTimeout base clock divisor (toutBaseClk)"]
pub type TimeoutBaseClkDivisorToutBaseClkR = crate::FieldReader;
#[doc = "Field `TimeoutBaseClkDivisorToutBaseClk` writer - newverTimeout base clock divisor (toutBaseClk)"]

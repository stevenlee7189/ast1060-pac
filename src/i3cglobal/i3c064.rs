#[doc = "Register `I3C064` reader"]
pub type R = crate::R<I3c064Spec>;
#[doc = "Register `I3C064` writer"]
pub type W = crate::W<I3c064Spec>;
...
impl W {
    #[doc = "Bit 0 - mode_i2c"]
    #[inline(always)]
    pub fn modei2c(&mut self) -> Modei2cW<I3c064Spec> {
        Modei2cW::new(self, 0)
    }
    #[doc = "Bit 1 - slv_test_mode"]
    #[inline(always)]
    pub fn slvtestmode(&mut self) -> SlvtestmodeW<I3c064Spec> {
        SlvtestmodeW::new(self, 1)
    }
    #[doc = "Bits 2:3 - act_mode"]
    #[inline(always)]
    pub fn actmode(&mut self) -> ActmodeW<I3c064Spec> {
        ActmodeW::new(self, 2)
    }
    #[doc = "Bits 4:7 - pending_int"]
    #[inline(always)]
    pub fn pendingint(&mut self) -> PendingintW<I3c064Spec> {
        PendingintW::new(self, 4)
    }
    #[doc = "Bits 8:14 - static_addr"]
    #[inline(always)]
    pub fn staticaddr(&mut self) -> StaticaddrW<I3c064Spec> {
        StaticaddrW::new(self, 8)
    }
    #[doc = "Bit 15 - static_addr_en"]
    #[inline(always)]
    pub fn staticaddren(&mut self) -> StaticaddrenW<I3c064Spec> {
        StaticaddrenW::new(self, 15)
    }
    #[doc = "Bits 16:19 - inst_id"]
    #[inline(always)]
    pub fn instid(&mut self) -> InstidW<I3c064Spec> {
        InstidW::new(self, 16)
    }
}
#[doc = "I3C6Reg1\n\nYou can [`read`](crate::Reg::read) this register and get [`i3c064::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3c064::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I3c064Spec;
impl crate::RegisterSpec for I3c064Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i3c064::R`](R) reader structure"]
impl crate::Readable for I3c064Spec {}
#[doc = "`write(|w| ..)` method takes [`i3c064::W`](W) writer structure"]
impl crate::Writable for I3c064Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I3C064 to value 0"]
impl crate::Resettable for I3c064Spec {}

#[doc = "Register `I3C030` reader"]
pub type R = crate::R<I3c030Spec>;
#[doc = "Register `I3C030` writer"]
pub type W = crate::W<I3c030Spec>;
...
impl W {
    #[doc = "Bits 0:3 - DG_SDA_FMAX"]
    #[inline(always)]
    pub fn dgsdafmax(&mut self) -> DgsdafmaxW<I3c030Spec> {
        DgsdafmaxW::new(self, 0)
    }
    #[doc = "Bits 4:7 - DG_SDA_RMAX"]
    #[inline(always)]
    pub fn dgsdarmax(&mut self) -> DgsdarmaxW<I3c030Spec> {
        DgsdarmaxW::new(self, 4)
    }
    #[doc = "Bits 8:11 - DG_SCL_FMAX"]
    #[inline(always)]
    pub fn dgsclfmax(&mut self) -> DgsclfmaxW<I3c030Spec> {
        DgsclfmaxW::new(self, 8)
    }
    #[doc = "Bits 12:15 - DG_SCL_RMAX"]
    #[inline(always)]
    pub fn dgsclrmax(&mut self) -> DgsclrmaxW<I3c030Spec> {
        DgsclrmaxW::new(self, 12)
    }
    #[doc = "Bits 16:23 - CDR_DLYMAX"]
    #[inline(always)]
    pub fn cdrdlymax(&mut self) -> CdrdlymaxW<I3c030Spec> {
        CdrdlymaxW::new(self, 16)
    }
    #[doc = "Bit 24 - CDR_EN_DG"]
    #[inline(always)]
    pub fn cdrendg(&mut self) -> CdrendgW<I3c030Spec> {
        CdrendgW::new(self, 24)
    }
    #[doc = "Bit 25 - CDR_EN_MASK"]
    #[inline(always)]
    pub fn cdrenmask(&mut self) -> CdrenmaskW<I3c030Spec> {
        CdrenmaskW::new(self, 25)
    }
    #[doc = "Bit 28 - SDA_PULLUP_EN_2K"]
    #[inline(always)]
    pub fn sdapullupen2k(&mut self) -> Sdapullupen2kW<I3c030Spec> {
        Sdapullupen2kW::new(self, 28)
    }
    #[doc = "Bit 29 - SDA_PULLUP_EN_750"]
    #[inline(always)]
    pub fn sdapullupen750(&mut self) -> Sdapullupen750W<I3c030Spec> {
        Sdapullupen750W::new(self, 29)
    }
}
#[doc = "I3C3Reg0\n\nYou can [`read`](crate::Reg::read) this register and get [`i3c030::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3c030::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I3c030Spec;
impl crate::RegisterSpec for I3c030Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i3c030::R`](R) reader structure"]
impl crate::Readable for I3c030Spec {}
#[doc = "`write(|w| ..)` method takes [`i3c030::W`](W) writer structure"]
impl crate::Writable for I3c030Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I3C030 to value 0"]
impl crate::Resettable for I3c030Spec {}

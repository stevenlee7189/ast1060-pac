#[doc = "Register `I3C010` reader"]
pub type R = crate::R<I3c010Spec>;
#[doc = "Register `I3C010` writer"]
pub type W = crate::W<I3c010Spec>;
...
impl W {
    #[doc = "Bits 0:3 - DG_SDA_FMAX"]
    #[inline(always)]
    pub fn dgsdafmax(&mut self) -> DgsdafmaxW<I3c010Spec> {
        DgsdafmaxW::new(self, 0)
    }
    #[doc = "Bits 4:7 - DG_SDA_RMAX"]
    #[inline(always)]
    pub fn dgsdarmax(&mut self) -> DgsdarmaxW<I3c010Spec> {
        DgsdarmaxW::new(self, 4)
    }
    #[doc = "Bits 8:11 - DG_SCL_FMAX"]
    #[inline(always)]
    pub fn dgsclfmax(&mut self) -> DgsclfmaxW<I3c010Spec> {
        DgsclfmaxW::new(self, 8)
    }
    #[doc = "Bits 12:15 - DG_SCL_RMAX"]
    #[inline(always)]
    pub fn dgsclrmax(&mut self) -> DgsclrmaxW<I3c010Spec> {
        DgsclrmaxW::new(self, 12)
    }
    #[doc = "Bits 16:23 - CDR_DLYMAX"]
    #[inline(always)]
    pub fn cdrdlymax(&mut self) -> CdrdlymaxW<I3c010Spec> {
        CdrdlymaxW::new(self, 16)
    }
    #[doc = "Bit 24 - CDR_EN_DG"]
    #[inline(always)]
    pub fn cdrendg(&mut self) -> CdrendgW<I3c010Spec> {
        CdrendgW::new(self, 24)
    }
    #[doc = "Bit 25 - CDR_EN_MASK"]
    #[inline(always)]
    pub fn cdrenmask(&mut self) -> CdrenmaskW<I3c010Spec> {
        CdrenmaskW::new(self, 25)
    }
    #[doc = "Bit 28 - SDA_PULLUP_EN_2K"]
    #[inline(always)]
    pub fn sdapullupen2k(&mut self) -> Sdapullupen2kW<I3c010Spec> {
        Sdapullupen2kW::new(self, 28)
    }
    #[doc = "Bit 29 - SDA_PULLUP_EN_750"]
    #[inline(always)]
    pub fn sdapullupen750(&mut self) -> Sdapullupen750W<I3c010Spec> {
        Sdapullupen750W::new(self, 29)
    }
}
#[doc = "I3C1Reg0\n\nYou can [`read`](crate::Reg::read) this register and get [`i3c010::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3c010::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I3c010Spec;
impl crate::RegisterSpec for I3c010Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i3c010::R`](R) reader structure"]
impl crate::Readable for I3c010Spec {}
#[doc = "`write(|w| ..)` method takes [`i3c010::W`](W) writer structure"]
impl crate::Writable for I3c010Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I3C010 to value 0"]
impl crate::Resettable for I3c010Spec {}

#[doc = "Register `I3CD25C` reader"]
pub type R = crate::R<I3cd25cSpec>;
#[doc = "Register `I3CD25C` writer"]
pub type W = crate::W<I3cd25cSpec>;
...
impl W {}
#[doc = "Device Characteristic Table Location-4 of Device6 (Master Mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`i3cd25c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3cd25c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I3cd25cSpec;
impl crate::RegisterSpec for I3cd25cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i3cd25c::R`](R) reader structure"]
impl crate::Readable for I3cd25cSpec {}
#[doc = "`write(|w| ..)` method takes [`i3cd25c::W`](W) writer structure"]
impl crate::Writable for I3cd25cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I3CD25C to value 0"]
impl crate::Resettable for I3cd25cSpec {}

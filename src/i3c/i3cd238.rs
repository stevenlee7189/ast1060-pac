#[doc = "Register `I3CD238` reader"]
pub type R = crate::R<I3cd238Spec>;
#[doc = "Register `I3CD238` writer"]
pub type W = crate::W<I3cd238Spec>;
...
impl W {}
#[doc = "Device Characteristic Table Location-3 of Device4 (Master Mode)\n\nYou can [`read`](crate::Reg::read) this register and get [`i3cd238::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3cd238::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I3cd238Spec;
impl crate::RegisterSpec for I3cd238Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i3cd238::R`](R) reader structure"]
impl crate::Readable for I3cd238Spec {}
#[doc = "`write(|w| ..)` method takes [`i3cd238::W`](W) writer structure"]
impl crate::Writable for I3cd238Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I3CD238 to value 0"]
impl crate::Resettable for I3cd238Spec {}

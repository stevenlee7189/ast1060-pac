#[doc = "Register `I3CD290` reader"]
pub type R = crate::R<I3cd290Spec>;
#[doc = "Register `I3CD290` writer"]
pub type W = crate::W<I3cd290Spec>;
...
impl W {
    #[doc = "Bits 0:6 - DEV_STATIC_ADDR"]
    #[inline(always)]
    pub fn devstaticaddr(&mut self) -> DevstaticaddrW<I3cd290Spec> {
        DevstaticaddrW::new(self, 0)
    }
    #[doc = "Bit 11 - Packet Error Check enabled for accepted IBI from the device. PEC byte is appended at the end of IBI data from the"]
    #[inline(always)]
    pub fn ibipecen(&mut self) -> IbipecenW<I3cd290Spec> {
        IbipecenW::new(self, 11)
    }
    #[doc = "Bit 12 - Mandatory one or more data bytes follow the accepted IBI from the device. Data byte continuation is indicated by"]
    #[inline(always)]
    pub fn ibiwithdata(&mut self) -> IbiwithdataW<I3cd290Spec> {
        IbiwithdataW::new(self, 12)
    }
    #[doc = "Bit 13 - In-Band Slave Interrupt Request Reject field is used to control, per device, whether to accept Master request from"]
    #[inline(always)]
    pub fn sirreject(&mut self) -> SirrejectW<I3cd290Spec> {
        SirrejectW::new(self, 13)
    }
    #[doc = "Bit 14 - In-Band Master Request Reject field is used to control, per device, whether to accept Master request from Devices."]
    #[inline(always)]
    pub fn mrreject(&mut self) -> MrrejectW<I3cd290Spec> {
        MrrejectW::new(self, 14)
    }
    #[doc = "Bits 16:23 - DEV_DYNAMIC_ADDR"]
    #[inline(always)]
    pub fn devdynamicaddr(&mut self) -> DevdynamicaddrW<I3cd290Spec> {
        DevdynamicaddrW::new(self, 16)
    }
    #[doc = "Bits 29:30 - DEV_NACK_RETRY_CNT"]
    #[inline(always)]
    pub fn devnackretrycnt(&mut self) -> DevnackretrycntW<I3cd290Spec> {
        DevnackretrycntW::new(self, 29)
    }
    #[doc = "Bit 31 - LEGACY_I2C_DEVICE"]
    #[inline(always)]
    pub fn legacyi2cdevice(&mut self) -> Legacyi2cdeviceW<I3cd290Spec> {
        Legacyi2cdeviceW::new(self, 31)
    }
}
#[doc = "Device Address Table of Device5\n\nYou can [`read`](crate::Reg::read) this register and get [`i3cd290::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3cd290::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I3cd290Spec;
impl crate::RegisterSpec for I3cd290Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i3cd290::R`](R) reader structure"]
impl crate::Readable for I3cd290Spec {}
#[doc = "`write(|w| ..)` method takes [`i3cd290::W`](W) writer structure"]
impl crate::Writable for I3cd290Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I3CD290 to value 0"]
impl crate::Resettable for I3cd290Spec {}

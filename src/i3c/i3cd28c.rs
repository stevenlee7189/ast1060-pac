#[doc = "Register `I3CD28C` reader"]
pub type R = crate::R<I3cd28cSpec>;
#[doc = "Register `I3CD28C` writer"]
pub type W = crate::W<I3cd28cSpec>;
...
impl W {
    #[doc = "Bits 0:6 - DEV_STATIC_ADDR"]
    #[inline(always)]
    pub fn devstaticaddr(&mut self) -> DevstaticaddrW<I3cd28cSpec> {
        DevstaticaddrW::new(self, 0)
    }
    #[doc = "Bit 11 - Packet Error Check enabled for accepted IBI from the device. PEC byte is appended at the end of IBI data from the"]
    #[inline(always)]
    pub fn ibipecen(&mut self) -> IbipecenW<I3cd28cSpec> {
        IbipecenW::new(self, 11)
    }
    #[doc = "Bit 12 - Mandatory one or more data bytes follow the accepted IBI from the device. Data byte continuation is indicated by"]
    #[inline(always)]
    pub fn ibiwithdata(&mut self) -> IbiwithdataW<I3cd28cSpec> {
        IbiwithdataW::new(self, 12)
    }
    #[doc = "Bit 13 - In-Band Slave Interrupt Request Reject field is used to control, per device, whether to accept Master request from"]
    #[inline(always)]
    pub fn sirreject(&mut self) -> SirrejectW<I3cd28cSpec> {
        SirrejectW::new(self, 13)
    }
    #[doc = "Bit 14 - In-Band Master Request Reject field is used to control, per device, whether to accept Master request from Devices."]
    #[inline(always)]
    pub fn mrreject(&mut self) -> MrrejectW<I3cd28cSpec> {
        MrrejectW::new(self, 14)
    }
    #[doc = "Bits 16:23 - DEV_DYNAMIC_ADDR"]
    #[inline(always)]
    pub fn devdynamicaddr(&mut self) -> DevdynamicaddrW<I3cd28cSpec> {
        DevdynamicaddrW::new(self, 16)
    }
    #[doc = "Bits 29:30 - DEV_NACK_RETRY_CNT"]
    #[inline(always)]
    pub fn devnackretrycnt(&mut self) -> DevnackretrycntW<I3cd28cSpec> {
        DevnackretrycntW::new(self, 29)
    }
    #[doc = "Bit 31 - LEGACY_I2C_DEVICE"]
    #[inline(always)]
    pub fn legacyi2cdevice(&mut self) -> Legacyi2cdeviceW<I3cd28cSpec> {
        Legacyi2cdeviceW::new(self, 31)
    }
}
#[doc = "Device Address Table of Device4\n\nYou can [`read`](crate::Reg::read) this register and get [`i3cd28c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`i3cd28c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct I3cd28cSpec;
impl crate::RegisterSpec for I3cd28cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`i3cd28c::R`](R) reader structure"]
impl crate::Readable for I3cd28cSpec {}
#[doc = "`write(|w| ..)` method takes [`i3cd28c::W`](W) writer structure"]
impl crate::Writable for I3cd28cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets I3CD28C to value 0"]
impl crate::Resettable for I3cd28cSpec {}

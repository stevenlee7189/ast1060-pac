#[doc = "Register `WDT02C` reader"]
pub type R = crate::R<Wdt02cSpec>;
#[doc = "Register `WDT02C` writer"]
pub type W = crate::W<Wdt02cSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Reserved"]
    #[inline(always)]
    pub fn reserved7(&mut self) -> Reserved7W<Wdt02cSpec> {
        Reserved7W::new(self, 0)
    }
    #[doc = "Bit 4 - Enable reset SOC controller"]
    #[inline(always)]
    pub fn enbl_rst_socctrl(&mut self) -> EnblRstSocctrlW<Wdt02cSpec> {
        EnblRstSocctrlW::new(self, 4)
    }
    #[doc = "Bit 5 - Enable reset MAC controller"]
    #[inline(always)]
    pub fn enbl_rst_macctrl(&mut self) -> EnblRstMacctrlW<Wdt02cSpec> {
        EnblRstMacctrlW::new(self, 5)
    }
    #[doc = "Bit 5 - Reserved"]
    #[inline(always)]
    pub fn reserved6(&mut self) -> Reserved6W<Wdt02cSpec> {
        Reserved6W::new(self, 5)
    }
    #[doc = "Bit 6 - Reserved"]
    #[inline(always)]
    pub fn reserved5(&mut self) -> Reserved5W<Wdt02cSpec> {
        Reserved5W::new(self, 6)
    }
    #[doc = "Bit 7 - Enable reset JTAG #1 master controller"]
    #[inline(always)]
    pub fn enbl_rst_jtag1master_ctrl(&mut self) -> EnblRstJtag1masterCtrlW<Wdt02cSpec> {
        EnblRstJtag1masterCtrlW::new(self, 7)
    }
    #[doc = "Bit 8 - Enable reset JTAG #2 master controller"]
    #[inline(always)]
    pub fn enbl_rst_jtag2master_ctrl(&mut self) -> EnblRstJtag2masterCtrlW<Wdt02cSpec> {
        EnblRstJtag2masterCtrlW::new(self, 8)
    }
    #[doc = "Bit 9 - Enable reset GPIO controller"]
    #[inline(always)]
    pub fn enbl_rst_gpioctrl(&mut self) -> EnblRstGpioctrlW<Wdt02cSpec> {
        EnblRstGpioctrlW::new(self, 9)
    }
    #[doc = "Bit 10 - Enable reset MDC/MDIO controller"]
    #[inline(always)]
    pub fn enbl_rst_mdcmdioctrl(&mut self) -> EnblRstMdcmdioctrlW<Wdt02cSpec> {
        EnblRstMdcmdioctrlW::new(self, 10)
    }
    #[doc = "Bits 10:13 - Reserved"]
    #[inline(always)]
    pub fn reserved4(&mut self) -> Reserved4W<Wdt02cSpec> {
        Reserved4W::new(self, 10)
    }
    #[doc = "Bit 11 - Enable reset LPC controller"]
    #[inline(always)]
    pub fn enbl_rst_lpcctrl(&mut self) -> EnblRstLpcctrlW<Wdt02cSpec> {
        EnblRstLpcctrlW::new(self, 11)
    }
    #[doc = "Bit 12 - Enable reset PECI controller"]
    #[inline(always)]
    pub fn enbl_rst_pecictrl(&mut self) -> EnblRstPecictrlW<Wdt02cSpec> {
        EnblRstPecictrlW::new(self, 12)
    }
    #[doc = "Bit 13 - Enable reset PWM controller"]
    #[inline(always)]
    pub fn enbl_rst_pwmctrl(&mut self) -> EnblRstPwmctrlW<Wdt02cSpec> {
        EnblRstPwmctrlW::new(self, 13)
    }
    #[doc = "Bit 14 - Enable reset ADC controller"]
    #[inline(always)]
    pub fn enbl_rst_adcctrl(&mut self) -> EnblRstAdcctrlW<Wdt02cSpec> {
        EnblRstAdcctrlW::new(self, 14)
    }
    #[doc = "Bit 15 - Reserved"]
    #[inline(always)]
    pub fn reserved3(&mut self) -> Reserved3W<Wdt02cSpec> {
        Reserved3W::new(self, 15)
    }
    #[doc = "Bit 16 - Enable reset I2C/I2CFLT controller"]
    #[inline(always)]
    pub fn enbl_rst_i2ci2cfltctrl(&mut self) -> EnblRstI2ci2cfltctrlW<Wdt02cSpec> {
        EnblRstI2ci2cfltctrlW::new(self, 16)
    }
    #[doc = "Bit 17 - Enable reset I3C Global controller"]
    #[inline(always)]
    pub fn enbl_rst_i3cglobal_ctrl(&mut self) -> EnblRstI3cglobalCtrlW<Wdt02cSpec> {
        EnblRstI3cglobalCtrlW::new(self, 17)
    }
    #[doc = "Bit 18 - Enable reset I3C bus1 controller"]
    #[inline(always)]
    pub fn enbl_rst_i3cbus1ctrl(&mut self) -> EnblRstI3cbus1ctrlW<Wdt02cSpec> {
        EnblRstI3cbus1ctrlW::new(self, 18)
    }
    #[doc = "Bit 19 - Enable reset I3C bus2 controller"]
    #[inline(always)]
    pub fn enbl_rst_i3cbus2ctrl(&mut self) -> EnblRstI3cbus2ctrlW<Wdt02cSpec> {
        EnblRstI3cbus2ctrlW::new(self, 19)
    }
    #[doc = "Bit 20 - Enable reset I3C bus3 controller"]
    #[inline(always)]
    pub fn enbl_rst_i3cbus3ctrl(&mut self) -> EnblRstI3cbus3ctrlW<Wdt02cSpec> {
        EnblRstI3cbus3ctrlW::new(self, 20)
    }
    #[doc = "Bit 21 - Enable reset I3C bus4 controller"]
    #[inline(always)]
    pub fn enbl_rst_i3cbus4ctrl(&mut self) -> EnblRstI3cbus4ctrlW<Wdt02cSpec> {
        EnblRstI3cbus4ctrlW::new(self, 21)
    }
    #[doc = "Bit 22 - Enable reset SPI1/SPI2 controller"]
    #[inline(always)]
    pub fn enbl_rst_spi1spi2ctrl(&mut self) -> EnblRstSpi1spi2ctrlW<Wdt02cSpec> {
        EnblRstSpi1spi2ctrlW::new(self, 22)
    }
    #[doc = "Bits 23:25 - Reserved"]
    #[inline(always)]
    pub fn reserved1(&mut self) -> Reserved1W<Wdt02cSpec> {
        Reserved1W::new(self, 23)
    }
    #[doc = "Bits 23:31 - Reserved"]
    #[inline(always)]
    pub fn reserved2(&mut self) -> Reserved2W<Wdt02cSpec> {
        Reserved2W::new(self, 23)
    }
    #[doc = "Bit 26 - Enable reset eSPI controller"]
    #[inline(always)]
    pub fn enbl_rst_espictrl(&mut self) -> EnblRstEspictrlW<Wdt02cSpec> {
        EnblRstEspictrlW::new(self, 26)
    }
}
#[doc = "WDTn Software Mode Reset Mask Register \\#2\n\nYou can [`read`](crate::Reg::read) this register and get [`wdt02c::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wdt02c::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Wdt02cSpec;
impl crate::RegisterSpec for Wdt02cSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`wdt02c::R`](R) reader structure"]
impl crate::Readable for Wdt02cSpec {}
#[doc = "`write(|w| ..)` method takes [`wdt02c::W`](W) writer structure"]
impl crate::Writable for Wdt02cSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets WDT02C to value 0"]
impl crate::Resettable for Wdt02cSpec {}

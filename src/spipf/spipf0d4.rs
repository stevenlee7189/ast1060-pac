#[doc = "Register `SPIPF0D4` reader"]
pub type R = crate::R<Spipf0d4Spec>;
#[doc = "Register `SPIPF0D4` writer"]
pub type W = crate::W<Spipf0d4Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Command"]
    #[inline(always)]
    pub fn cmd(&mut self) -> CmdW<Spipf0d4Spec> {
        CmdW::new(self, 0)
    }
    #[doc = "Bits 8:9 - Address Bit width"]
    #[inline(always)]
    pub fn addr_bit_width(&mut self) -> AddrBitWidthW<Spipf0d4Spec> {
        AddrBitWidthW::new(self, 8)
    }
    #[doc = "Bits 10:12 - Address Mask"]
    #[inline(always)]
    pub fn addr_mask(&mut self) -> AddrMaskW<Spipf0d4Spec> {
        AddrMaskW::new(self, 10)
    }
    #[doc = "Bits 13:15 - Program or Erase Size"]
    #[inline(always)]
    pub fn program_or_erase_size(&mut self) -> ProgramOrEraseSizeW<Spipf0d4Spec> {
        ProgramOrEraseSizeW::new(self, 13)
    }
    #[doc = "Bits 16:21 - Number of Dummy Cycles"]
    #[inline(always)]
    pub fn number_of_dummy_cycles(&mut self) -> NumberOfDummyCyclesW<Spipf0d4Spec> {
        NumberOfDummyCyclesW::new(self, 16)
    }
    #[doc = "Bit 23 - Lock"]
    #[inline(always)]
    pub fn lock(&mut self) -> LockW<Spipf0d4Spec> {
        LockW::new(self, 23)
    }
    #[doc = "Bits 24:25 - Data Bit width"]
    #[inline(always)]
    pub fn data_bit_width(&mut self) -> DataBitWidthW<Spipf0d4Spec> {
        DataBitWidthW::new(self, 24)
    }
    #[doc = "Bit 26 - Memory Command"]
    #[inline(always)]
    pub fn memory_cmd(&mut self) -> MemoryCmdW<Spipf0d4Spec> {
        MemoryCmdW::new(self, 26)
    }
    #[doc = "Bit 27 - Read Command"]
    #[inline(always)]
    pub fn read_cmd(&mut self) -> ReadCmdW<Spipf0d4Spec> {
        ReadCmdW::new(self, 27)
    }
    #[doc = "Bit 28 - Write Command"]
    #[inline(always)]
    pub fn wr_cmd(&mut self) -> WrCmdW<Spipf0d4Spec> {
        WrCmdW::new(self, 28)
    }
    #[doc = "Bit 29 - Generic"]
    #[inline(always)]
    pub fn generic(&mut self) -> GenericW<Spipf0d4Spec> {
        GenericW::new(self, 29)
    }
    #[doc = "Bit 30 - Valid"]
    #[inline(always)]
    pub fn valid(&mut self) -> ValidW<Spipf0d4Spec> {
        ValidW::new(self, 30)
    }
    #[doc = "Bit 31 - Valid Once"]
    #[inline(always)]
    pub fn valid_once(&mut self) -> ValidOnceW<Spipf0d4Spec> {
        ValidOnceW::new(self, 31)
    }
}
#[doc = "Allow Command Table \\#1 $\\sim$ \\#32\n\nYou can [`read`](crate::Reg::read) this register and get [`spipf0d4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spipf0d4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Spipf0d4Spec;
impl crate::RegisterSpec for Spipf0d4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`spipf0d4::R`](R) reader structure"]
impl crate::Readable for Spipf0d4Spec {}
#[doc = "`write(|w| ..)` method takes [`spipf0d4::W`](W) writer structure"]
impl crate::Writable for Spipf0d4Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SPIPF0D4 to value 0"]
impl crate::Resettable for Spipf0d4Spec {}

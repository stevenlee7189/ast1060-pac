...
impl W {
    #[doc = "Bits 0:7 - Port GPIOM\\[7:0\\] input mask"]
    #[inline(always)]
    pub fn port_gpiom70input_mask(&mut self) -> PortGpiom70inputMaskW<Gpio108Spec> {
        PortGpiom70inputMaskW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Port GPION\\[7:0\\] input mask"]
    #[inline(always)]
    pub fn port_gpion70input_mask(&mut self) -> PortGpion70inputMaskW<Gpio108Spec> {
        PortGpion70inputMaskW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Port GPIOO\\[7:0\\] input mask"]
    #[inline(always)]
    pub fn port_gpioo70input_mask(&mut self) -> PortGpioo70inputMaskW<Gpio108Spec> {
        PortGpioo70inputMaskW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Port GPIOP\\[7:0\\] input mask"]
    #[inline(always)]
    pub fn port_gpiop70input_mask(&mut self) -> PortGpiop70inputMaskW<Gpio108Spec> {

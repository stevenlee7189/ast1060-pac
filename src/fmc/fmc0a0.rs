#[doc = "Register `FMC0A0` reader"]
pub type R = crate::R<Fmc0a0Spec>;
#[doc = "Register `FMC0A0` writer"]
pub type W = crate::W<Fmc0a0Spec>;
...
pub enum EnblReadwrCmdFilterForCe0 {
    ...
    #[doc = "1: enable filter, only commands defined in \\hlink{FMC100 $\\sim$ \\hlink{FMC17C are allowed."]
    EnableFilterOnlyCommandsDefinedInHlinkFmc100SimHlinkFmc17cAreAllowed = 1,
}
...
impl EnblReadwrCmdFilterForCe0R {
    ...
    pub const fn variant(&self) -> EnblReadwrCmdFilterForCe0 {
        match self . bits { false => EnblReadwrCmdFilterForCe0 :: DisableFilterAllCommandsAreAllowed , true => EnblReadwrCmdFilterForCe0 :: EnableFilterOnlyCommandsDefinedInHlinkFmc100SimHlinkFmc17cAreAllowed , }
    }
    ...
    #[doc = "enable filter, only commands defined in \\hlink{FMC100 $\\sim$ \\hlink{FMC17C are allowed."]
    #[inline(always)]
    pub fn is_enable_filter_only_commands_defined_in_hlink_fmc100_sim_hlink_fmc17c_are_allowed(
        &self,
    ) -> bool {
        * self == EnblReadwrCmdFilterForCe0 :: EnableFilterOnlyCommandsDefinedInHlinkFmc100SimHlinkFmc17cAreAllowed
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    #[doc = "enable filter, only commands defined in \\hlink{FMC100 $\\sim$ \\hlink{FMC17C are allowed."]
    #[inline(always)]
    pub fn enable_filter_only_commands_defined_in_hlink_fmc100_sim_hlink_fmc17c_are_allowed(
        self,
    ) -> &'a mut crate::W<REG> {
        self . variant (EnblReadwrCmdFilterForCe0 :: EnableFilterOnlyCommandsDefinedInHlinkFmc100SimHlinkFmc17cAreAllowed)
    }
}
...
impl W {
    #[doc = "Bit 0 - Enable read/write command filter for CE0"]
    #[inline(always)]
    pub fn enbl_readwr_cmd_filter_for_ce0(&mut self) -> EnblReadwrCmdFilterForCe0W<Fmc0a0Spec> {
        EnblReadwrCmdFilterForCe0W::new(self, 0)
    }
    #[doc = "Bit 1 - Enable read/write command filter for CE1"]
    #[inline(always)]
    pub fn enbl_readwr_cmd_filter_for_ce1(&mut self) -> EnblReadwrCmdFilterForCe1W<Fmc0a0Spec> {
    ...
    pub fn enbl0x03and0x13in_fully_qualified_cmd_list(
        &mut self,
    ) -> Enbl0x03and0x13inFullyQualifiedCmdListW<Fmc0a0Spec> {
        Enbl0x03and0x13inFullyQualifiedCmdListW::new(self, 31)
    }
}
#[doc = "Command Filter Control Register\n\nYou can [`read`](crate::Reg::read) this register and get [`fmc0a0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmc0a0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fmc0a0Spec;
impl crate::RegisterSpec for Fmc0a0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fmc0a0::R`](R) reader structure"]
impl crate::Readable for Fmc0a0Spec {}
#[doc = "`write(|w| ..)` method takes [`fmc0a0::W`](W) writer structure"]
impl crate::Writable for Fmc0a0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FMC0A0 to value 0x8000_0000"]
impl crate::Resettable for Fmc0a0Spec {

#[doc = "Register `FMC114` reader"]
pub type R = crate::R<Fmc114Spec>;
#[doc = "Register `FMC114` writer"]
pub type W = crate::W<Fmc114Spec>;
...
impl W {
    #[doc = "Bits 0:7 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd14(&mut self) -> FullyQualifiedCmd14W<Fmc114Spec> {
        FullyQualifiedCmd14W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Fully qualified Command"]
    #[inline(always)]
    pub fn fully_qualified_cmd5(&mut self) -> FullyQualifiedCmd5W<Fmc114Spec> {
        FullyQualifiedCmd5W::new(self, 8)
    }
    #[doc = "Bit 31 - Enable Entry"]
    #[inline(always)]
    pub fn enbl_entry5(&mut self) -> EnblEntry5W<Fmc114Spec> {
        EnblEntry5W::new(self, 31)
    }
}
#[doc = "Fully Qualified Command\n\nYou can [`read`](crate::Reg::read) this register and get [`fmc114::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fmc114::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fmc114Spec;
impl crate::RegisterSpec for Fmc114Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fmc114::R`](R) reader structure"]
impl crate::Readable for Fmc114Spec {}
#[doc = "`write(|w| ..)` method takes [`fmc114::W`](W) writer structure"]
impl crate::Writable for Fmc114Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FMC114 to value 0x8000_0006"]
impl crate::Resettable for Fmc114Spec {
    const RESET_VALUE: u32 = 0x8000_0006;
}
